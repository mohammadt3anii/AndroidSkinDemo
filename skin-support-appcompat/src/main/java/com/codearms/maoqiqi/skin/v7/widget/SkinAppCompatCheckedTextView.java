...
/**
 * 定义SkinAppCompatCheckedTextView继承AppCompatCheckedTextView,实现Skinable接口,实现更新皮肤功能
 * Author: fengqi.mao.march@gmail.com
 * Date: 2018/9/20 22:30
 */
public class SkinAppCompatCheckedTextView extends AppCompatCheckedTextView implements Skinable {
    ...
    public SkinAppCompatCheckedTextView(Context context) {
        this(context, null);
    }

    public SkinAppCompatCheckedTextView(Context context, AttributeSet attrs) {
        this(context, attrs, android.support.v7.appcompat.R.attr.checkedTextViewStyle);
    }

    public SkinAppCompatCheckedTextView(Context context, AttributeSet attrs, int defStyleAttr) {
