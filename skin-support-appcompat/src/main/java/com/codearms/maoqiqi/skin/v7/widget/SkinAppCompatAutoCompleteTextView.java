...
/**
 * 定义SkinAppCompatAutoCompleteTextView继承AppCompatAutoCompleteTextView,实现Skinable接口,实现更新皮肤功能
 * Author: fengqi.mao.march@gmail.com
 * Date: 2018/9/19 13:57
 */
public class SkinAppCompatAutoCompleteTextView extends AppCompatAutoCompleteTextView implements Skinable {
    ...
    public SkinAppCompatAutoCompleteTextView(Context context) {
        this(context, null);
    }

    public SkinAppCompatAutoCompleteTextView(Context context, AttributeSet attrs) {
        this(context, attrs, android.support.v7.appcompat.R.attr.autoCompleteTextViewStyle);
    }

    public SkinAppCompatAutoCompleteTextView(Context context, AttributeSet attrs, int defStyleAttr) {
