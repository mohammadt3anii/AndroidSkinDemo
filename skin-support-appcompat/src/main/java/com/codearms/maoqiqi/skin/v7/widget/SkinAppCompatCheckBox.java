 ...
 */
public class SkinAppCompatCheckBox extends AppCompatCheckBox implements Skinable {
    ...
    public SkinAppCompatCheckBox(Context context) {
        this(context, null);
    }

    public SkinAppCompatCheckBox(Context context, AttributeSet attrs) {
        this(context, attrs, android.support.v7.appcompat.R.attr.checkboxStyle);
    }

    public SkinAppCompatCheckBox(Context context, AttributeSet attrs, int defStyleAttr) {
