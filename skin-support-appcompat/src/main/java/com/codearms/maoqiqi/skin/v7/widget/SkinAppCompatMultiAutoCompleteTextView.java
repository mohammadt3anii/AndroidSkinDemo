...
/**
 * 定义SkinAppCompatMultiAutoCompleteTextView继承AppCompatMultiAutoCompleteTextView,实现Skinable接口,实现更新皮肤功能
 * Author: fengqi.mao.march@gmail.com
 * Date: 2018/9/19 13:58
 */
public class SkinAppCompatMultiAutoCompleteTextView extends AppCompatMultiAutoCompleteTextView implements Skinable {
    ...
    public SkinAppCompatMultiAutoCompleteTextView(Context context) {
        this(context, null);
    }

    public SkinAppCompatMultiAutoCompleteTextView(Context context, AttributeSet attrs) {
        this(context, attrs, android.support.v7.appcompat.R.attr.autoCompleteTextViewStyle);
    }

    public SkinAppCompatMultiAutoCompleteTextView(Context context, AttributeSet attrs, int defStyleAttr) {
